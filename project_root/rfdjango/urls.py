...
urlpatterns = [
    ...
    # url('transmitters/<slug:name>/<str:lat>/<str:lon>/', show_detailmap),

    # # Class-based View (C.B.V.)
    url(r'^transmitters/(?P<service>[A-Z]{2,3})/$', TransmitterList.as_view(), name='transmitter_list'),
    url(r'^transmitters/$', TransmitterList.as_view(), name='transmitter_list'),
    ...
    url(r'^rfdjango/fieldmeas/(?P<pk>\d+)/$', FieldMeasurementDetail.as_view(), name='fieldmeasurement_detail'),
    url(r'^rfdjango/fieldmeas/$', FieldMeasurementList.as_view(), name='fieldmeasurement_list'),
    url(r'^rfdjango/fieldmeas/new/$', FieldMeasurementCreate.as_view(), name='fieldmeasurement_new'),
    url(r'^rfdjango/fieldmeas/(?P<pk>\d+)/edit/$', FieldMeasurementUpdate.as_view(), name='fieldmeasurement_edit'),
    url(r'^rfdjango/fieldmeas/(?P<pk>\d+)/delete/$', FieldMeasurementDelete.as_view(), name='fieldmeasurement_delete'),
